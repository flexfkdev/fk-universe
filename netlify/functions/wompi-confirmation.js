...
//   dev: https://api.v2.dev.mpr.mipaquete.com/api
...
const MI_PAQUETE_BASE = process.env.MI_PAQUETE_BASE || 'https://api.v2.dev.mpr.mipaquete.com/api';

// Headers reales confirmados por la documentación (Postman collection):
//   apikey: el JWT de autenticación (SIN prefijo "Bearer")
//   session-tracker: un UUID de sesión/integración
